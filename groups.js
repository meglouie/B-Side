document.addEventListener("DOMContentLoaded", () => {
  ...
  const seedPosts = [
    {
      title: "Favorite rock band?",
      body: "I can't decide between Led Zeppelin and The Rolling Stones. What do you think?",
      tag: "General",
      likes: 7,
      author: "Megan"
    },
    {
      title: "Best Paramore album?",
      body: "Riot! or After Laughter? Their evolution is insane!",
      tag: "Album Talk",
      likes: 5,
      author: "Khanh Ha"
    }
